...
export function CheckoutDialog({
  ...
  const handleOrderCreation = async (txHash: string) => {
    try {
      toast.success("Payment confirmed! Creating order...");
      ...
      toast.error("Payment confirmed but failed to create order. Please contact support with your transaction hash.");
    }
  };
